...
const DropdownMenu = () => {
  ...
  return (
    <div ref={ref} className="relative inline-block text-left">
      ...
      {isOpen && (
        <div className="absolute mt-1 right-0 z-10 w-32 rounded-lg shadow bg-background border">
          <ul
            className="p-1"
            role="menu"
            ...
            {options.map((option) => (
              <li key={option.id}>
                ...
                >
                  {
                    {
                      light: <SunIcon className="w-4 h-4 mr-1" />,
                      dark: <MoonIcon className="w-4 h-4 mr-1" />,
                      system: <SystemIcon className="w-4 h-4 mr-1" />,
                    }[option.id as Theme]
                  }{" "}
                  {option.label}
                </button>
